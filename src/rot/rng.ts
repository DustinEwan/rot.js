 ...
 */
export class RNG {
	private static _s0: number = 0;
	private static _s1: number = 0;
	private static _s2: number = 0;
	private static _c: number = 0;
	private static _frac: number = 2.3283064365386963e-10; /* 2^-32 */
	 ...
	 */
	static getUniformInt(lowerBound, upperBound) {
